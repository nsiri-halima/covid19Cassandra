...
static int IDCity;
 ...
 try {
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        IDCity =Integer.parseInt(jtxtCityID.getText());
       City city = new City(IDCity, this.jtxtCityName.getText(), Double.parseDouble(this.jtxtLongitude.getText()), Double.parseDouble(this.jtxtLatitude.getText()), Double.parseDouble(this.jSpPopulation.getValue().toString()));
        try {
            //insertion d'une nouvelle ville
            CityEntity.UpdateCity(city,IDCity);
            //recuperer tous les cities inseres dans la bases
            List<City> Cities = CityEntity.selectAll(this.jtxtDbName.getText());
            //Creer un model pour la table/schema
            DefaultTableModel model = new DefaultTableModel(new Object[]{"ID City", "City Name", "Longitude", "Latitude", "Population"}, 0);
 ...
 try {
            IDCity =Integer.parseInt(jtxtCityID.getText());
            CityEntity.deleteCity(IDCity,jtxtDbName.getText());
 ...
 int i = jTbCities.getSelectedRow();
        ...
        IDCity = Integer.parseInt(model.getValueAt(jTbCities.getSelectedRow(), 0).toString());
        ...
        jSpPopulation.setValue(model.getValueAt(i, 4));        // TODO add your handling code here:
